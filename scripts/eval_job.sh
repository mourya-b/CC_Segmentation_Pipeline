...
#SBATCH --output=/data/diag/mouryaBandaru/experiments/classifier_v17/logs/eval_%j.out
#SBATCH --error=/data/diag/mouryaBandaru/experiments/classifier_v17/logs/eval_%j.err
