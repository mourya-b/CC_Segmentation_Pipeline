...
#SBATCH --output=/data/diag/mouryaBandaru/experiments/classifier_v4/logs/eval_%j.out
#SBATCH --error=/data/diag/mouryaBandaru/experiments/classifier_v4/logs/eval_%j.err
...
python -m src.evaluation.evaluate_classifier \
  ...
  --checkpoint /data/diag/mouryaBandaru/experiments/classifier_v4/best_classifier.pth