...
#SBATCH --output=/data/diag/mouryaBandaru/experiments/classifier_v7/logs/%j.out
#SBATCH --error=/data/diag/mouryaBandaru/experiments/classifier_v7/logs/%j.err

mkdir -p /data/diag/mouryaBandaru/experiments/classifier_v7/logs
