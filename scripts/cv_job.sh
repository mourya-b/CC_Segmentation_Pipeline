...
#SBATCH --output=/data/diag/mouryaBandaru/experiments/classifier_v18/logs/cv_%j.out
#SBATCH --error=/data/diag/mouryaBandaru/experiments/classifier_v18/logs/cv_%j.err
