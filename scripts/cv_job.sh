...
#SBATCH --output=/data/diag/mouryaBandaru/experiments/classifier_v18b/logs/cv_%j.out
#SBATCH --error=/data/diag/mouryaBandaru/experiments/classifier_v18b/logs/cv_%j.err
