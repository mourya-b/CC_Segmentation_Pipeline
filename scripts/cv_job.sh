...
#SBATCH --output=/data/diag/mouryaBandaru/experiments/classifier_v12/logs/cv_%j.out
#SBATCH --error=/data/diag/mouryaBandaru/experiments/classifier_v12/logs/cv_%j.err

mkdir -p /data/diag/mouryaBandaru/experiments/classifier_v12/logs
